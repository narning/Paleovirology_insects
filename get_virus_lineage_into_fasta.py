...
with open( sys.argv[ 2].split(".fa")[ 0] + "_pluslineage_filter_less_80aa.fa", "w+") as outf:
    with open( sys.argv[ 2]) as fasta:
        ...
        for entry in fasta_handle:
            ...
            if len(entry) > 1:
                ...
                if header[0] in virus_lineage_dict:
                    header[0] = header[0] + " " +  virus_lineage_dict[ header[0]]
                else:
